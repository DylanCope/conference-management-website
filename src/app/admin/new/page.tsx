  ...
  return (
    <main style={{padding:24,fontFamily:'Inter, system-ui, Arial'}}>
      ...
      <form method="post" action="/api/conferences" style={{maxWidth:640, marginTop:12}}>
        ...
        <input name="name" style={{width:'100%', padding:8, border:'1px solid #ddd', borderRadius:4}} />

        <label style={{display:'block', marginTop:10}}>Website</label>
        <input name="website" style={{width:'100%', padding:8, border:'1px solid #ddd', borderRadius:4}} />
